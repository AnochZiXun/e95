									...
									<TABLE class="form">
										...
										<TR>
											<TR>
												...
												<TD>
													<INPUT id="question" name="question" required="" type="text" value="{form/question}"/>
												</TD>
												<TD>必填。</TD>
											</TR>
										</TR>
										<TR>
											...
											<TD>
												<TEXTAREA id="answer" cols="1" name="answer" required="" rows="1">
													<xsl:value-of select="form/answer"/>
												</TEXTAREA>
											</TD>
											<TD>必填。</TD>
										</TR>
