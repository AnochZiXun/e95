										...
										<xsl:for-each select="list/row">
											<TR>
												...
												<TD class="textAlignCenter">
													<A class="fa fa-edit fa-2x" title="編輯" href="/cPanel/merchandiseSpecification/{id}.asp">&#160;</A>
													<B class="blank">&#160;</B>
													<A class="fa fa-remove fa-2x delete" title="刪除" href="/cPanel/merchandiseSpecification/{id}/remove.json">&#160;</A>
												</TD>
											</TR>
										</xsl:for-each>
									</TBODY>
